---
description: Risk-based анализ для приоритизации тестирования — строит реестр риск-областей, оценивает каждую по «вероятность дефекта × влияние», ранжирует по матрице и назначает рекомендованную глубину проверки, чтобы направить ограниченные усилия туда, где они важнее всего.
