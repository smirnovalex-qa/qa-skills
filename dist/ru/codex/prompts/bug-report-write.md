---
description: Помогает составить короткий, информативный баг-репорт в фиксированной структуре (Название, Описание, Приоритет, Статус, Дата обнаружения, Шаги для воспроизведения, Ожидаемый результат, Фактический результат).
